...
export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'emergency_services_description': 'Quick access to urgent medical care when you need it most. Our services are available 24/7.',
    'for_life_threatening': 'For life-threatening emergencies',
    'book_service': 'Book Service',
    'important_note': 'Important Note',
    'emergency_services_disclaimer': 'Please use these services responsibly. For immediate life-threatening emergencies, always call the national emergency number first.',
    'emergency_disclaimer_1': 'Response times may vary based on demand and location',
    'emergency_disclaimer_2': 'Charges apply based on the service type and distance',
    'emergency_disclaimer_3': 'Keep your medical history and emergency contacts ready',
    'logout': 'Logout',
    'register': 'Register',
    ...
    'previously_browsed_items': 'Previously Browsed Items',
    'read_in_english': 'Read in English',
    'read_in_hindi': 'हिंदी में पढ़ें',
    'view_all': 'View All',
    'off': 'OFF',
    'offers_just_for_you': 'Offers Just for you',
    ...
    'reorder_previous_purchases': 'Reorder your previous purchases',
    ...
    // Duplicate key, removing
    // 'previously_browsed_items': 'Previously Browsed Items',
    'recently_viewed_products': 'Your recently viewed products',
    'today': 'Today',
    'yesterday': 'Yesterday',
    'handpicked_just_for_you': 'Handpicked products just for you',
    'featured_products': 'Featured Products',
    'health_services': 'Health Services',
    'comprehensive_healthcare_solutions': 'Comprehensive healthcare solutions for you and your family',
    'doctor_consultation': 'Doctor Consultation',
    'consult_with_top_doctors': 'Consult with top doctors online',
    'lab_tests': 'Lab Tests',
    'book_lab_tests_home_collection': 'Book lab tests with home collection',
    'medicine_delivery': 'Medicine Delivery',
    'doorstep_delivery_of_medicines': 'Doorstep delivery of medicines',
    'health_checkups': 'Health Checkups',
    'comprehensive_health_packages': 'Comprehensive health packages',
    'home_healthcare': 'Home Healthcare',
    'healthcare_services_at_home': 'Healthcare services at home',
    'health_chat': 'Health Chat',
    'chat_with_ai_health_assistant': 'Chat with AI health assistant',
    'explore': 'Explore',
    'nearby_hospitals': 'Nearby Hospitals',
    'emergency_healthcare_facilities_nearby': 'Emergency healthcare facilities near you',
    'add_hospital': 'Add Hospital',
    'add_hospital_information': 'Add Hospital Information',
    'hospital_name': 'Hospital Name',
    // Already defined above, using existing definition
    // 'address': 'Address',
    'phone_number': 'Phone Number',
    'specialties': 'Specialties',
    'comma_separated': 'Comma separated',
    'provides_emergency_care': 'Provides emergency care',
    'save': 'Save',
    'emergency_care': 'Emergency Care',
    'call_now': 'Call Now',
    'add_local_hospital': 'Add Local Hospital',
    'help_community_by_adding': 'Help your community by adding a local hospital',
    'delivered': 'Delivered',
  ...
  hi: {
    ...
    // Previously added this key, keeping it for compatibility
    // 'previously_browsed_items': 'पहले देखे गए उत्पाद',
    'read_in_english': 'Read in English',
    'read_in_hindi': 'हिंदी में पढ़ें',
    'view_all': 'सभी देखें',
    'off': 'छूट',
    'offers_just_for_you': 'सिर्फ आपके लिए ऑफर',
