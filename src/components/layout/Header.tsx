    ...
    <header className="shadow-sm sticky top-0 z-50 bg-white">
      ...
      <div className="bg-orange-500 text-white text-xs py-1 px-4 hidden md:block">
        <div className="container mx-auto flex justify-between items-center">
          <div>
            <span className="mr-4">
              <i className="fas fa-phone-alt mr-1"></i> 877
            </span>
            <span>
      ...
      <nav className="border-t border-gray-200 py-2 overflow-x-auto hidden md:block">
        <div className="container mx-auto px-4">
          <ul className="flex space-x-8 text-sm font-medium">
            ...
            <li><Link href="/doctors" className="text-orange-500 font-semibold flex items-center">
              <i className="fas fa-stethoscope mr-1"></i> Consult Doctors
            </Link></li>
